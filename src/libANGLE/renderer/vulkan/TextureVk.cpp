...
// TextureVk.cpp: Implements the class methods for TextureVk.
...
TextureVk::TextureVk() : TextureImpl()
{
}
...
void TextureVk::setUsage(GLenum usage)
{
    UNIMPLEMENTED();
}
...
gl::Error TextureVk::generateMipmaps(const gl::TextureState &textureState)
{
    UNIMPLEMENTED();
    return gl::Error(GL_INVALID_OPERATION);
}
