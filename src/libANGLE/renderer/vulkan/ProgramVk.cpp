...
// ProgramVk.cpp: Implements the class methods for ProgramVk.
...
ProgramVk::ProgramVk(const gl::Program::Data &data) : ProgramImpl(data)
{
}
...
LinkResult ProgramVk::link(const gl::Data &data, gl::InfoLog &infoLog)
{
    UNIMPLEMENTED();
    return LinkResult(false, gl::Error(GL_INVALID_OPERATION));
}
