                                   ...
                                   ID3D11ShaderResourceView **outSRV)
{
    ...
    // TODO(jmadill): only enable on workaround.
    bool dropStencil = (d3d11::GetDXGIFormatInfo(mFormatInfo.dsvFormat).stencilBits > 0);
    ...
    SRVKey key(effectiveBaseLevel, mipLevels, swizzleRequired, dropStencil);
