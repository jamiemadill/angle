...
call:BuildShader BlitDepthStencil.hlsl   VS_BlitDepthStencil      vs_4_1         compiled/blitdepthstencil11_vs.h     %debug%
call:BuildShader BlitDepthStencil.hlsl   PS_BlitDepthMS           ps_4_1         compiled/blitdepthms11_ps.h          %debug%
call:BuildShader BlitDepthStencil.hlsl   PS_BlitStencilMS         ps_4_1         compiled/blitstencilms11_ps.h        %debug%
