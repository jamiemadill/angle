...
void VertexArray::setVertexAttribDivisor(size_t index, GLuint divisor)
{
    ...
    mDirtyBits.markDirty(DIRTY_BIT_ATTRIB_0_DIVISOR << index);
}
...
void VertexArray::enableAttribute(size_t attributeIndex, bool enabledState)
{
    ...
    mDirtyBits.markDirty(DIRTY_BIT_ATTRIB_0_ENABLED << attributeIndex);
                                    ...
                                    bool normalized, bool pureInteger, GLsizei stride, const void *pointer)
{
    ...
    mDirtyBits.markDirty(DIRTY_BIT_ATTRIB_0_POINTER << attributeIndex);
}

void VertexArray::setElementArrayBuffer(Buffer *buffer)
{
    mData.mElementArrayBuffer.set(buffer);
    mDirtyBits.markDirty(DIRTY_BIT_ELEMENT_ARRAY_BUFFER);
}
