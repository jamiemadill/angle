        ...
        ['angle_enable_vulkan==1',
        {
            ...
            [
                ...
                },
                {
                    ...
                    'sources':
                    [
                        '<(vulkan_path)/layers/vk_layer_config.cpp',
                        '<(vulkan_path)/layers/vk_layer_extension_utils.cpp',
                        '<(vulkan_path)/layers/vk_layer_utils.cpp',
                    ],
                    'include_dirs':
                    [
                        '<(vulkan_path)/include',
                    ...
                    [
                        {
                            ...
                            'inputs':
                            [
                                '<(vulkan_path)/vk-generate.py',
                                '<(vulkan_path)/vulkan.py'
                            ],
                            'outputs':
                            [
                            ...
                            [
                                ...
                                'python <(vulkan_path)/vk-generate.py Win32 dispatch-table-ops layer > <(angle_gen_path)/vulkan/vk_dispatch_table_helper.h',
                            ],
                        },
                        {
                ...
                },
                {
                    ...
                    'sources':
                    [
                        '<(vulkan_path)/layers/draw_state.cpp',
                        '<(vulkan_path)/layers/draw_state.h',
                        '<(vulkan_path)/layers/vk_layer_table.cpp',
                        '<(vulkan_path)/layers/vk_layer_table.h',
                    ],
                    'include_dirs':
                    [
                        '<(angle_gen_path)/vulkan',
                    ...
                    [
                        {
                            ...
                            [
                                # Hack this in one line so we can redirect stdout
                                # TODO(jmadill): Select correct display server for Linux/Android/etc.
                                'python <(vulkan_path)/vk-generate.py Win32 win-def-file VkLayer_draw_state layer > <(angle_gen_path)/vulkan/VkLayer_draw_state.def',
                            ],
                        },
                    ],
                },
